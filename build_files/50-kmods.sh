...
#
# Usage: run by build.sh; no arguments. KMODS_IN names the staged tree
#   (default /kmods, the Containerfile's mount of the builder stage).
# Writes: /usr/lib/modules/<kernel>/updates/<name>.ko per module, and the
