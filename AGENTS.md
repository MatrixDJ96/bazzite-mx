...
docs/                       architecture.md (build flow, state, gates), conventions.md (bash, tests, CI, commits), divergences.md (what changes over Bazzite, why), migration.md (moving a host to v2)
```
